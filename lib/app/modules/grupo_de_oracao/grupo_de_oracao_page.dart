...
class GrupoDeOracaoPage extends StatefulWidget {
  final String title;
  const GrupoDeOracaoPage({Key key, this.title = "Grupo De Oração"})
      : super(key: key);

  @override
  _GrupoDeOracaoPageState createState() => _GrupoDeOracaoPageState();
}

class _GrupoDeOracaoPageState extends State<GrupoDeOracaoPage> {
  @override
