...
class ConferenciaSaoVicentePage extends StatefulWidget {
  final String title;
  const ConferenciaSaoVicentePage(
      {Key key, this.title = "Conferência São Vicente de Paulo"})
      : super(key: key);

  @override
  _ConferenciaSaoVicentePageState createState() =>
      _ConferenciaSaoVicentePageState();
}

class _ConferenciaSaoVicentePageState extends State<ConferenciaSaoVicentePage> {
  @override
        ...
        child: SingleChildScrollView(
          child: FutureBuilder<DocumentSnapshot>(
              future: Firestore.instance
                  ...
                  .document('conferencia_sao_vicente')
                  .get(),
